...
/*
 * Crie uma classe chamada LinguagemFavorita que contenha um atributo chamado nome, anoDeCriacao e ide.Em seguida, crie um conjunto com 3 linguagens e faça um programa que ordene esse conjunto por:
 * 1.Ordem de Inserção.
...
public class LinguagemFavorita {
    ...
    public static final String ide = null;
    public static final int anoDeCriacao = 0;

    public LinguagemFavorita(String string, int i, String string2) {
    }
